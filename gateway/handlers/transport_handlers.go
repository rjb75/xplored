...
func AllShortTransportHandler(c *fiber.Ctx) error {

	TransportationURI := fmt.Sprintf("http://%s:%s/transportation/api/v1/allshort", os.Getenv("GATEWAY_TRANSPORTATION_HOST"), os.Getenv("TRANSPORTATION_PORT"))
